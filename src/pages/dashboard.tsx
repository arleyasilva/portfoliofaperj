...
const Dashboard: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <SEO
        title="Dashboard Visual – FAPERJ Portfolio"
        description="Visualização consolidada de indicadores de fomento, pesquisas e investimentos da FAPERJ."
        url="https://portfolio-faperj.vercel.app/dashboard"
