...
// NOVAS INTERFACES PARA A COLUNA DE DESTAQUES
interface LinkItem {
  title: string;
  url: string;
}
...
// Componente para renderizar a lista aninhada de Destaques
const DestaquesColumn = () => {
  ...
  const destaquesData: NestedItem[] = [
    {
      id: 'medicina-saude',
      label: 'Medicina e Saúde',
      items: [
        { title: 'UFF identifica molécula ligada ao glaucoma e abre caminho para novos fármacos', url: 'https://www.youtube.com/watch?v=-1hdMYUkcV8' },
        { title: 'UFRJ busca recuperar fígados doentes para reduzir a fila de transplantes', url: 'https://www.youtube.com/watch?v=W-LBGHzTmd0' },
        { title: 'IEN estuda taurina nanoencapsulada para bloquear placas beta-amiloide', url: 'https://www.youtube.com/watch?v=xP4ZfhF9EGo' },
        { title: 'Needier/UFRJ desenvolve diagnóstico inovador para pacientes de câncer', url: 'https://www.youtube.com/watch?v=qTj8K1d70eU' },
        { title: 'Instituto Vital Brazil integra rede de 21 laboratórios oficiais', url: 'https://www.youtube.com/watch?v=THgq3usGt18' },
        { title: 'Pesquisador da UFRJ estuda o uso de algas para produção de biocombustíveis', url: 'https://www.youtube.com/watch?v=S2fF_X0mY8c' },
        { title: 'Aplicativo ‘Enf na Dose Certa’ auxilia enfermagem a administrar medicamentos', url: 'https://www.youtube.com/watch?v=CNnnSvWRmvA' },
      ],
    },
    {
      ...
      items: [
        { title: 'Museu da Vida busca vida em microorganismos em lugares inusitados', url: 'https://www.youtube.com/watch?v=yWzYJ8K0gXo' },
        { title: 'Navio-laboratório forma alunos e impulsiona pesquisa no mar', url: 'https://www.youtube.com/watch?v=gYWbqxIH9GI' },
        { title: 'Pesquisador da UERJ alerta para as mudanças climáticas', url: 'https://www.youtube.com/watch?v=C78n8zX4iYI' },
      ],
    },
    {
      id: 'inovacao-empreendedorismo',
      label: 'Inovação e Empreendedorismo',
      items: [
        { title: 'UFRJ estuda o uso de nanocelulose em embalagens', url: 'https://www.youtube.com/watch?v=nE3Gk-K4W2I' },
        { title: 'FAPERJ/Firjan/Sebrae-RJ de Apoio ao Design', url: 'https://www.youtube.com/watch?v=0w1g0-bH9qU' },
      ],
    },
    {
      id: 'tecnologia',
      label: 'Tecnologia',
      items: [
        { title: 'UFRJ desenvolve ferramenta para detecção de fraudes em sistemas de água', url: 'https://www.youtube.com/watch?v=X-4eT-E5D5c' },
      ],
    },
    {
      id: 'pesquisa-basica',
      ...
      items: [
        { title: 'Matemático do IMPA recebe prêmio internacional por pesquisas em geometria', url: 'https://www.youtube.com/watch?v=Y_k4x7u_g_A' },
      ],
    },
    {
      id: 'cultura-economia',
      label: 'Cultura e Economia Criativa',
      items: [
        { title: 'Cineasta do Rio filma documentário sobre a história das comunidades ribeirinhas do estado', url: 'https://www.youtube.com/watch?v=J9f2X-0mH7E' },
        { title: 'Arquivo Geral evidencia papel do RJ na Independência do Brasil', url: 'https://www.youtube.com/watch?v=3aodM9Yx4H8' },
        { title: 'Pioneiro da historiografia fluminense lança obra sobre a história do Rio', url: 'https://www.youtube.com/watch?v=R94yF0tW2y8' },
      ],
    },
    {
      id: 'educacao',
      label: 'Educação',
      items: [
        { title: 'UERJ estuda o impacto de novas tecnologias no desempenho de atletas olímpicos', url: 'https://www.youtube.com/watch?v=S0g2F7z9C8w' },
      ],
    },
  ];

  const renderNestedItems = (items: (NestedItem | LinkItem)[]) => {
    return items.map((item) => {
      // Adicionamos um identificador único para os itens de link
      const isLink = 'url' in item;
      const itemId = isLink ? item.url : item.id;
  ...
  return (
    <List sx={{ p: 0, flexGrow: 1, backgroundColor: 'transparent' }}>
      {renderNestedItems(destaquesData)}
    </List>
  );
};
...
const BannerHeader = styled(Box)<BannerHeaderProps>(({ theme }) => ({
  height: 150,
  width: '100%',
  ...
  const columnsData: ColumnData[] = [
    ...
    },
    {
      ...
      items: [
        {
          id: 'pappe',
          label: 'PAPPE (Subvenção Rio Inovação FAPERJ/Finep)',
        ...
        {
          id: 'apoio-inovacao-tecnologica-geral',
        ...
        {
          id: 'desenvolvimento-ti-programa',
        ...
        {
          id: 'modelos-inovacao-tecnologica-social',
        ...
        {
          id: 'apoio-incubadoras-empresas-base-tecnologica',
        ...
        {
          id: 'apoio-inovacoes-esporte-programa',
        ...
        {
          id: 'apoio-equipes-discentes-projetos-tecnologicos-educacionais',
    ...
    },
    {
      ...
      items: [], // Esta lista será ignorada, pois a coluna é renderizada pelo DestaquesColumn
    },
  ];
        ...
        {columnsData.map((column, colIndex) => (
          <Box key={colIndex} sx={{ width: '33.33%', p: 0 }}>
            <StyledCard>
              ...
              {column.title === 'Destaques FAPERJ' ? (
                <DestaquesColumn />
              ) : (
                <List sx={{ p: 0, flexGrow: 1, backgroundColor: 'transparent', }}>
                  {column.items.slice(0, 10).map((item) => (
                    <Box key={item.id}>
                      {column.title === 'Programas' ? (
                        <>
                          <MuiLink
                            component="button"
                            color="inherit"
              ...
              {column.title !== 'Destaques FAPERJ' && column.items.length > 10 && (
