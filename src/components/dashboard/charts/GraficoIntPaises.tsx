...
import { IntPaisesData } from "@/types/faperj";
...
const GraficoIntPaises: React.FC = () => {
  const { data, loading, error } = useFaperjData<IntPaisesData[]>("int_paises");
...
export default GraficoIntPaises;
