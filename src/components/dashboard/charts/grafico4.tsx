...
// Reestruturando os dados para o formato esperado pelo Recharts Treemap
...
const CustomizedTreemapContent: React.FC<any> = (props) => {
  const { x, y, width, height, name, value, colors, index } = props; // <-- AQUI! Adicionado 'index'
  const fontSize = 12;
  ...
  return (
    <g>
      <rect
        ...
        height={height}
        style={{
          fill: colors[index % colors.length], // <-- AQUI! Usando o índice para a cor
          stroke: '#fff',
          strokeWidth: 2,
        }}
      />
...
const Grafico4 = (): JSX.Element => {
  ...
  return (
    <ChartCard
      title="Gráfico 4 — Investimento Global por micro-áreas"
      borderColor="#5EB3E6"
      loading={loading}
      error={error}
